---
title: "Atelier Series Guide"
pubDate: "2021-06-24"
updatedDate: "2025-09-27"
heroImage: "/media/blog/atelier-series-guide/atelier-series-guide.webp"
description: "In a 26 game series, it's completely understandable to not know where to start.  I'm here to break it down for you."
author: "Chloe"
tags: [Atelier Series, Feature]
---

In a 26 game series, it's completely understandable to not know where to start.  I'm here to break it down for you. We usually pretend the first ten games don't even exist when talking about what to recommend, and that still leaves a staggering amount of "modern"  games left to talk about.

# Overview

<img class="w-33 right" style="aspect-ratio: 350/495; max-width:350px;" src="/media/blog/atelier-series-guide/comfy-soph.webp"></img>
...
You wanna start with Yumia? Start with Yumia. It's not related to any other games and it's the latest in the series. If you want to get in the series when the discounts are rolling, read on.
...
**Note: Wait until Ryza DX releases on November 13. There is no longer any point in buying the original releases of the Ryza trilogy.**
...
### Rorona
<div class="w-50 card right card-body"> 

***Note***

Under no circumstances should you get the original PS3 version of this game. It has been partially remade, and thus you should only purchase versions marked with **Plus or DX**. </div>
...
* Iris 1 (A6) <span class="badge bg-primary">PS2</span></td>
* Iris 2 (A7) <span class="badge bg-primary">PS2</span></td>
* Iris 3 (A8) <span class="badge bg-primary">PS2</span></td>
...
* Mana Khemia 1 (A9) <span class="badge bg-primary">PS2</span></td> <span class="badge bg-primary">PSP</span></td>
* Mana Khemia 2 (A10) <span class="badge bg-primary">PS2</span></td>
...
<img class="w-33 right" style="aspect-ratio: 350/415; max-width:350px;" src="/media/blog/atelier-series-guide/arland2.webp" loading="lazy"></img>

* Rorona (A11) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS Now</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Totori (A12) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Meruru (A13) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Lulua (A20) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
...
<img class="w-33 right" style="aspect-ratio: 350/495; max-width:350px;" src="/media/blog/atelier-series-guide/dusk.webp" loading="lazy"></img>

* Ayesha (A14) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS Now</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Escha & Logy (A15) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS Now</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Shallie (A16) <span class="badge bg-primary">PS3</span> <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS Now</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
...
<img class="w-33 right" style="aspect-ratio: 350/461; max-width:350px;" src="/media/blog/atelier-series-guide/mysterious.webp" loading="lazy"></img>

* Sophie (A17) <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Firis (A18) <span class="badge bg-primary">Vita</span> <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Lydie & Suelle (A19) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Sophie 2 (A23) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
...
<img class="w-33 right" style="aspect-ratio: 350/433; max-width:350px;" src="/media/blog/atelier-series-guide/ryza2.webp" loading="lazy"></img>

*  Ryza 1 (A21) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Ryza 2 (A22) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">PS5</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Ryza 3 (A24) <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">PS5</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
...
* Nelke & The Legendary Alchemists <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
* Atelier Annie <span class="badge bg-primary">DS</span>
* Atelier Marie + Elie (A1 + A2) <span class="badge bg-primary">PS2</span>
* Atelier Marie Remake <span class="badge bg-primary">PS4</span> <span class="badge bg-primary">PS5</span> <span class="badge bg-primary">Switch</span> <span class="badge bg-primary">PC</span>
