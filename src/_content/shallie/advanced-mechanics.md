...
* Item Damage = Base Effect * Effect Power Scaling * Property Bonuses * Crit Power * Skill/Item Power * [Heroic Bonus](shallie/properties/heroic-soul) * (1 + Burst Power * Chain Bonus) * Level Bonus Multiplier
...
* [Talisman of Ancient Beasts](shallie/items/talisman-of-ancient-beasts) ([PSE](shallie/properties/property-super-enhance) / [JB](shallie/properties/jumbo-blessing) / [BKB](shallie/properties/beast-king-s-blade))
...
* Property Bonus:
  * PSE/ JB / [HCE](shallie/properties/high-cost-enhance) (9 slots): 3.30 (maximum property bonus, outside [LDP](shallie/properties/legend-destruct-power) and crits)
  * PSE / [CB](shallie/properties/cost-bonus) / JB (9 slots): 3.23
  * JB / PSE / Tier Zero property such as BKB (9 slots): 2.64
  * JB/HCE/tier zero (9 slots): 2.62
  * PSE / CB / top tier such as [Soul Dwelling](shallie/properties/soul-dwelling) (1 slot): 2.32
  * PSE / [Mach Throw](shallie/properties/mach-throw) / Tier Zero, such as a [Carries Heat](shallie/properties/carries-heat) bomb (1 slot): 1.62
...
* Let's stack!
  * [Ultimate Growth](shallie/effects/ultimate-growth) ([Thunder Outfit](shallie/items/thunder-outfit)), [Soul Evolution](shallie/effects/soul-evolution) ([Mirage Talisman](shallie/items/mirage-talisman)), [Awakened Soul](shallie/properties/awakened-soul) (armor property), [Soul Dwelling](shalile/properties/soul-dwelling) (item property) = 228% damage (multiplier in damage formula is 3.28)
...
* Caps
  ...
  * Skill power: NONE
    * Will increase the power of items, but only equipment effects; properties do nothing, with the exception of [Valorous Soul](shallie/properties/valorous-soul).
  * Damage reduction: 90%
    * Stacks additively with item effects and properties.
  * Skill WT: 50%
    * Affects regular attacks, but not items or defense.
    * Multiples with Quick reductions and item/skill effects (such as [Shortens Wait](shallie/effects/shortens-wait-l) or Wilbell's Rapid Action).
  * Burst Power: ?
...
Whimsical Talent (up to 20% reduction), stack additively. However, buffs like [Shortens Wait](shallie/effects/shortens-wait-l) and
Wilbell's Rapid Action will not stack; they replace each other. Skill WT reduction caps at 50%, and
that can generally be reached (or nearly reached) with a [Planet Sphere](shallie/items/planet-sphere) (44%). [Dark God Soul](shallie/properties/dark-god-soul)
...
Among items, [Lightning Bomb](shallie/items/lightning-bomb) is best for most debuffing purposes for its extremely short WT (13).
...
* **Assist Recovery**
  ...
  * For most characters, the cap is reached with [Earth Spirit Soul](shallie/properties/earth-spirit-soul) x2 or [Ultimate Assist Speed](shalile/effects/ultimate-assist-speed) on a 999 [Divine Soul](shallie/items/divine-soul).
  * Solle, Jurie, and especially Keith are slower than the rest.

* **Ailments**
  * [Strong Poison](shallie/effects/strong-poison)
