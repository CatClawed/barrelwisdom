...
export class NavigationService {
  ...
  getNav(section: string): Observable<any> {
    if(section && section != "tags" && section != "user" && section != "settings" && section != "create") {
        return this.http.get<any>(`${environment.dbUrl}${environment.apiUrl}/nav/${section}/`, this.httpOptions);
    }
    return this.http.get<any>(`${environment.dbUrl}${environment.apiUrl}/nav/blog/`, this.httpOptions);
  }
